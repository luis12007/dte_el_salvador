...
const cratecompra = async(req, res) => {
    ...
    if (plantilla.identificacion.tipoDte === "03") {
        JsontoDB = {
            ...
            /* pagos */
            periodo: Array.isArray(plantilla?.resumen?.pagos) && plantilla?.resumen?.pagos.length > 0 ? plantilla?.resumen?.pagos[0]?.periodo : null,
            montopago: Array.isArray(plantilla?.resumen?.pagos) && plantilla?.resumen?.pagos.length > 0 ? plantilla?.resumen?.pagos[0]?.montoPago : null,
            codigo: Array.isArray(plantilla?.resumen?.pagos) && plantilla?.resumen?.pagos.length > 0 ? plantilla?.resumen?.pagos[0]?.codigo : null,
            referencia: Array.isArray(plantilla?.resumen?.pagos) && plantilla?.resumen?.pagos.length > 0 ? plantilla?.resumen?.pagos[0]?.referencia : null,
            plazo: Array.isArray(plantilla?.resumen?.pagos) && plantilla?.resumen?.pagos.length > 0 ? plantilla?.resumen?.pagos[0]?.plazo : null,
