...
import ListReceptores from './ListReceptores';

const ClientCRCreate = ({
  setClient,
  client,
  ...
  const allActivities = [
    ...
    { value: "01491", label: "Cría de abejas apicultura para la obtención de miel y otros productos apícolas" },
    ...
    { value: "01500", label: "Cultivo de productos agrícolas en combinación con la cría de animales" },
    ...
    { value: "01614", label: "Servicios de contratación de mano de obra para la agricultura" },
    { value: "01619", label: "Servicios agrícolas ncp" },
    { value: "01621", label: "Actividades para mejorar la reproducción, el crecimiento y el rendimiento de los animales y sus productos" },
    { value: "01622", label: "Servicios de mano de obra pecuaria" },
    { value: "01629", label: "Servicios pecuarios ncp" },
    { value: "01631", label: "Labores post cosecha de preparación de los productos agrícolas para su comercialización o para la industria" },
    ...
    { value: "01700", label: "Caza ordinaria y mediante trampas, repoblación de animales de caza y servicios conexos" },
    ...
    { value: "08910", label: "Extracción de minerales para la fabricación de abonos y productos químicos" },
    ...
    { value: "09100", label: "Actividades de apoyo a la extracción de petróleo y gas natural" },
    { value: "09900", label: "Actividades de apoyo a la explotación de minas y canteras" },

    // INDUSTRIAS MANUFACTURERAS
    { value: "10101", label: "Servicio de rastros y mataderos de bovinos y porcinos" },
    ...
    { value: "10104", label: "Elaboración y conservación de embutidos y tripas naturales" },
    { value: "10105", label: "Servicios de conservación y empaque de carnes" },
    { value: "10106", label: "Elaboración y conservación de grasas y aceites animales" },
    { value: "10107", label: "Servicios de molienda de carne" },
    { value: "10108", label: "Elaboración de productos de carne ncp" },
    { value: "10201", label: "Procesamiento y conservación de pescado, crustáceos y moluscos" },
    { value: "10209", label: "Fabricación de productos de pescado ncp" },
    { value: "10301", label: "Elaboración de jugos de frutas y hortalizas" },
    { value: "10302", label: "Elaboración y envase de jaleas, mermeladas y frutas deshidratadas" },
    { value: "10309", label: "Elaboración de productos de frutas y hortalizas n.c.p." },
    { value: "10401", label: "Fabricación de aceites y grasas vegetales y animales comestibles" },
    { value: "10402", label: "Fabricación de aceites y grasas vegetales y animales no comestibles" },
    { value: "10409", label: "Servicio de maquilado de aceites" },
    { value: "10501", label: "Fabricación de productos lácteos excepto sorbetes y quesos sustitutos" },
    ...
    { value: "10612", label: "Elaboración de cereales para el desayuno y similares" },
    { value: "10613", label: "Servicios de beneficiado de productos agrícolas ncp" },
    { value: "10621", label: "Fabricación de almidón" },
    { value: "10628", label: "Servicio de molienda de maíz húmedo molino para nixtamal" },
    ...
    { value: "10722", label: "Molienda de caña de azúcar para la elaboración de dulces" },
    { value: "10723", label: "Elaboración de jarabes de azúcar y otros similares" },
    { value: "10724", label: "Maquilado de azúcar de caña" },
    { value: "10730", label: "Fabricación de cacao, chocolates y productos de confitería" },
    { value: "10740", label: "Elaboración de macarrones, fideos, y productos farináceos similares" },
    { value: "10750", label: "Elaboración de comidas y platos preparados para la reventa" },
    { value: "10791", label: "Elaboración de productos de café" },
    { value: "10792", label: "Elaboración de especies, sazonadores y condimentos" },
    ...
    { value: "10800", label: "Elaboración de alimentos preparados para animales" },
    ...
    { value: "13929", label: "Fabricación de artículos confeccionados con materiales textiles, excepto prendas de vestir ncp" },
    { value: "13930", label: "Fabricación de tapices y alfombras" },
    { value: "13941", label: "Fabricación de cuerdas de henequén y otras fibras naturales" },
    { value: "13942", label: "Fabricación de redes de diversos materiales" },
    { value: "13948", label: "Maquilado de productos trenzables de cualquier material" },
    { value: "13991", label: "Fabricación de adornos, etiquetas y otros artículos para prendas de vestir" },
    { value: "13992", label: "Servicio de bordados en artículos y prendas de tela" },
    { value: "13999", label: "Fabricación de productos textiles ncp" },

    // FABRICACIÓN DE PRENDAS DE VESTIR
    { value: "14101", label: "Fabricación de ropa interior, para dormir y similares" },
    { value: "14102", label: "Fabricación de ropa para niños" },
    { value: "14103", label: "Fabricación de prendas de vestir para ambos sexos" },
    { value: "14104", label: "Confección de prendas a medida" },
    { value: "14105", label: "Fabricación de prendas de vestir para deportes" },
    { value: "14106", label: "Elaboración de artesanías de uso personal confeccionadas de materiales textiles" },
    { value: "14108", label: "Maquilado de prendas de vestir, accesorios y otros" },
    { value: "14109", label: "Fabricación de prendas y accesorios de vestir n.c.p." },
    { value: "14200", label: "Fabricación de artículos de piel" },
    { value: "14301", label: "Fabricación de calcetines, calcetas, medias y otros similares" },
    { value: "14302", label: "Fabricación de ropa interior de tejido de punto" },
    { value: "14309", label: "Fabricación de prendas de vestir de tejido de punto ncp" },

    // FABRICACIÓN DE CUEROS Y PRODUCTOS CONEXOS
    { value: "15110", label: "Curtido y adobo de cueros; adobo y teñido de pieles" },
    { value: "15121", label: "Fabricación de maletas, bolsos de mano y otros artículos de marroquinería" },
    { value: "15122", label: "Fabricación de monturas, accesorios y vainas talabartería" },
    { value: "15123", label: "Fabricación de artesanías principalmente de cuero natural y sintético" },
    { value: "15128", label: "Maquilado de artículos de cuero natural, sintético y de otros materiales" },
    ...
    { value: "16210", label: "Fabricación de madera laminada, terciada, enchapada y contrachapada" },
    { value: "16220", label: "Fabricación de partes y piezas de carpintería para edificios y construcciones" },
    { value: "16230", label: "Fabricación de envases y recipientes de madera" },
    { value: "16292", label: "Fabricación de artesanías de madera, semillas, materiales trenzables" },
    { value: "16299", label: "Fabricación de productos de madera, corcho, paja y materiales trenzables ncp" },

    // FABRICACIÓN DE PAPEL Y DE PRODUCTOS DE PAPEL
    { value: "17010", label: "Fabricación de pasta de madera, papel y cartón" },
    { value: "17020", label: "Fabricación de papel y cartón ondulado y envases de papel y cartón" },
    { value: "17091", label: "Fabricación de artículos de papel y cartón de uso personal y doméstico" },
    ...
    { value: "20111", label: "Fabricación de materias primas para la fabricación de colorantes" },
    ...
    { value: "20130", label: "Fabricación de plástico y caucho en formas primarias" },
    { value: "20210", label: "Fabricación de plaguicidas y otros productos químicos de uso agropecuario" },
    { value: "20220", label: "Fabricación de pinturas, barnices y productos de revestimiento similares" },

    // FABRICACIÓN DE PRODUCTOS QUÍMICOS
    { value: "20231", label: "Fabricación de jabones, detergentes y similares para limpieza" },
    { value: "20232", label: "Fabricación de perfumes, cosméticos y productos de higiene y cuidado personal" },
    { value: "20291", label: "Fabricación de tintas y colores para escribir y pintar" },
    { value: "20292", label: "Fabricación de productos pirotécnicos, explosivos y municiones" },
    { value: "20299", label: "Fabricación de productos químicos n.c.p." },
    { value: "20300", label: "Fabricación de fibras artificiales" },

    // PRODUCTOS FARMACÉUTICOS
    { value: "21001", label: "Manufactura de productos farmacéuticos y productos botánicos" },
    { value: "21008", label: "Maquilado de medicamentos" },

    // PRODUCTOS DE CAUCHO Y PLÁSTICO
    { value: "22110", label: "Fabricación de cubiertas y cámaras; renovación y recauchutado de cubiertas" },
    { value: "22190", label: "Fabricación de otros productos de caucho" },
    { value: "22201", label: "Fabricación de envases plásticos" },
    { value: "22202", label: "Fabricación de productos plásticos para uso personal o doméstico" },
    ...
    { value: "23920", label: "Fabricación de productos de arcilla para la construcción" },
    { value: "23931", label: "Fabricación de productos de cerámica y porcelana no refractaria" },
    { value: "23932", label: "Fabricación de productos de cerámica y porcelana ncp" },
    { value: "23940", label: "Fabricación de cemento, cal y yeso" },
    { value: "23950", label: "Fabricación de artículos de hormigón, cemento y yeso" },
    { value: "23960", label: "Corte, tallado y acabado de la piedra" },
    { value: "23990", label: "Fabricación de productos minerales no metálicos ncp" },

    // FABRICACIÓN DE METALES COMUNES
    { value: "24100", label: "Industrias básicas de hierro y acero" },
    { value: "24200", label: "Fabricación de productos primarios de metales preciosos y metales no ferrosos" },
    ...
    { value: "25111", label: "Fabricación de productos metálicos para uso estructural" },
    { value: "25118", label: "Servicio de maquila para la fabricación de estructuras metálicas" },
    { value: "25120", label: "Fabricación de tanques, depósitos y recipientes de metal" },
    { value: "25130", label: "Fabricación de generadores de vapor" },
    { value: "25200", label: "Fabricación de armas y municiones" },
    { value: "25910", label: "Forjado, prensado, estampado y laminado de metales; pulvimetalurgia" },
    { value: "25920", label: "Tratamiento y revestimiento de metales" },
    { value: "25930", label: "Fabricación de artículos de cuchillería, herramientas de mano y ferretería" },
    { value: "25991", label: "Fabricación de envases y artículos conexos de metal" },
    { value: "25992", label: "Fabricación de artículos metálicos de uso personal y/o doméstico" },
    ...
    { value: "26400", label: "Fabricación de aparatos electrónicos de consumo" },
    { value: "26510", label: "Fabricación de instrumentos y aparatos de medición y control" },
    { value: "26520", label: "Fabricación de relojes y piezas de relojes" },
    { value: "26600", label: "Fabricación de equipo médico de irradiación y electrónico de uso médico" },
    { value: "26700", label: "Fabricación de instrumentos de óptica y equipo fotográfico" },
    { value: "26800", label: "Fabricación de medios magnéticos y ópticos" },

    // FABRICACIÓN DE EQUIPO ELÉCTRICO
    { value: "27100", label: "Fabricación de motores, generadores y transformadores eléctricos" },
    ...
    { value: "28110", label: "Fabricación de motores y turbinas, excepto para vehículos" },
    { value: "28120", label: "Fabricación de equipo hidráulico" },
    { value: "28130", label: "Fabricación de otras bombas, compresores, grifos y válvulas" },
    { value: "28140", label: "Fabricación de cojinetes, engranajes y piezas de transmisión" },
    { value: "28150", label: "Fabricación de hornos y quemadores" },
    { value: "28160", label: "Fabricación de equipo de elevación y manipulación" },
    { value: "28170", label: "Fabricación de maquinaria y equipo de oficina" },
    { value: "28180", label: "Fabricación de herramientas manuales" },
    { value: "28190", label: "Fabricación de otros tipos de maquinaria de uso general" },
    { value: "28210", label: "Fabricación de maquinaria agropecuaria y forestal" },
    { value: "28220", label: "Fabricación de máquinas para conformar metales y maquinaria herramienta" },
    { value: "28230", label: "Fabricación de maquinaria metalúrgica" },
    { value: "28240", label: "Fabricación de maquinaria para minería y construcción" },
    { value: "28250", label: "Fabricación de maquinaria para alimentos, bebidas y tabaco" },
    { value: "28260", label: "Fabricación de maquinaria para textiles, prendas de vestir y cueros" },
    ...
    { value: "29200", label: "Fabricación de carrocerías, remolques y semirremolques" },
    { value: "29300", label: "Fabricación de partes para vehículos automotores" },

    // FABRICACIÓN DE OTROS EQUIPOS DE TRANSPORTE
    { value: "30110", label: "Fabricación de buques" },
    { value: "30120", label: "Construcción y reparación de embarcaciones de recreo" },
    ...
    { value: "30920", label: "Fabricación de bicicletas y sillones de ruedas para inválidos" },
    { value: "30990", label: "Fabricación de equipo de transporte ncp" },

    // FABRICACIÓN DE MUEBLES
    { value: "31001", label: "Fabricación de colchones y somier" },
    { value: "31002", label: "Fabricación de muebles y otros productos de madera a medida" },
    ...
    { value: "32120", label: "Fabricación de joyas de imitación y artículos conexos" },
    ...
    { value: "32500", label: "Fabricación de instrumentos y materiales médicos y odontológicos" },
    { value: "32901", label: "Fabricación de lápices, bolígrafos y artículos de librería" },
    { value: "32902", label: "Fabricación de escobas, cepillos, pinceles y similares" },
    { value: "32903", label: "Fabricación de artesanías de materiales diversos" },
    { value: "32904", label: "Fabricación de artículos de uso personal y domésticos n.c.p." },
    { value: "32905", label: "Fabricación de accesorios para confecciones y marroquinería" },
    ...
    { value: "33110", label: "Reparación y mantenimiento de productos elaborados de metal" },
    { value: "33120", label: "Reparación y mantenimiento de maquinaria" },
    { value: "33130", label: "Reparación y mantenimiento de equipo electrónico y óptico" },
    { value: "33140", label: "Reparación y mantenimiento de equipo eléctrico" },
    { value: "33150", label: "Reparación y mantenimiento de equipo de transporte" },
    ...
    { value: "38302", label: "Reciclaje de desperdicios y desechos de plástico y caucho" },
    { value: "38303", label: "Reciclaje de desperdicios y desechos de vidrio" },
    { value: "38304", label: "Reciclaje de desperdicios y desechos de papel y cartón" },
    { value: "38305", label: "Reciclaje de desperdicios y desechos metálicos" },
    { value: "38309", label: "Reciclaje de desperdicios y desechos no metálicos n.c.p." },
    { value: "39000", label: "Actividades de Saneamiento y Gestión de Desechos" },
    ...
    { value: "43220", label: "Instalación de fontanería, calefacción y aire acondicionado" },
    ...
    { value: "45202", label: "Reparaciones eléctricas del automotor y recarga de baterías" },
    { value: "45203", label: "Enderezado y pintura de vehículos automotores" },
    { value: "45204", label: "Reparaciones de radiadores, escapes y silenciadores" },
    { value: "45205", label: "Reparación de artículos de fibra de vidrio para vehículos" },
    ...
    { value: "45301", label: "Venta de partes nuevas para vehículos automotores" },
    { value: "45302", label: "Venta de partes usadas para vehículos automotores" },
    ...
    { value: "46100", label: "Venta al por mayor a cambio de retribución o por contrata" },
    { value: "46201", label: "Venta al por mayor de materias primas agrícolas" },
    { value: "46202", label: "Venta al por mayor de productos de la silvicultura" },
    { value: "46203", label: "Venta al por mayor de productos pecuarios y de granja" },
    { value: "46211", label: "Venta de productos para uso agropecuario" },
    { value: "46291", label: "Venta al por mayor de granos básicos" },
    { value: "46292", label: "Venta al por mayor de semillas mejoradas para cultivo" },
    ...
    { value: "46377", label: "Venta al por mayor de pastas y aceites comestibles" },
    ...
    { value: "46394", label: "Venta al por mayor de refrescos y otras bebidas" },
    { value: "46395", label: "Venta al por mayor de cerveza y licores" },
    { value: "46396", label: "Venta al por mayor de hielo" },
    { value: "46411", label: "Venta al por mayor de productos textiles y mercería" },
    { value: "46412", label: "Venta al por mayor de artículos textiles excepto confecciones" },
    { value: "46413", label: "Venta al por mayor de confecciones textiles para el hogar" },
    ...
    { value: "46417", label: "Venta al por mayor de artículos de marroquinería" },
    { value: "46418", label: "Venta al por mayor de artículos de peletería" },
    { value: "46419", label: "Venta al por mayor de otros artículos textiles n.c.p." },
    ...
    { value: "46475", label: "Venta al por mayor de cámaras fotográficas y accesorios" },
    ...
    { value: "46491", label: "Venta al por mayor de productos medicinales y de limpieza" },
    ...
    { value: "46496", label: "Venta al por mayor de libros y artículos de papel" },
    { value: "46497", label: "Venta de artículos deportivos y juguetes" },
    { value: "46498", label: "Venta al por mayor de productos usados para el hogar" },
    { value: "46499", label: "Venta al por mayor de enseres domésticos n.c.p." },
    { value: "46500", label: "Venta al por mayor de bicicletas y accesorios" },
    { value: "46510", label: "Venta al por mayor de computadoras y programas informáticos" },
    { value: "46520", label: "Venta al por mayor de equipos de comunicación" },
    { value: "46530", label: "Venta al por mayor de maquinaria y equipo agropecuario" },
    { value: "46590", label: "Venta de equipos e instrumentos profesionales" },
    { value: "46591", label: "Venta al por mayor de maquinaria para la industria de la madera" },
    { value: "46592", label: "Venta al por mayor de maquinaria para la industria gráfica" },
    { value: "46593", label: "Venta al por mayor de maquinaria para la industria química" },
    { value: "46594", label: "Venta al por mayor de maquinaria para la industria metálica" },
    { value: "46595", label: "Venta al por mayor de equipamiento médico" },
    { value: "46596", label: "Venta al por mayor de maquinaria para la industria alimentaria" },
    { value: "46597", label: "Venta al por mayor de maquinaria para la industria textil" },
    { value: "46598", label: "Venta al por mayor de maquinaria para construcción y minería" },
    { value: "46599", label: "Venta al por mayor de otro tipo de maquinaria" },
    { value: "46610", label: "Venta al por mayor de combustibles" },
    { value: "46612", label: "Venta al por mayor de combustibles para automotores" },
    ...
    { value: "46620", label: "Venta al por mayor de metales y minerales metalíferos" },
    ...
    { value: "46639", label: "Venta al por mayor de materiales para la construcción n.c.p." },
    { value: "46691", label: "Venta al por mayor de sal industrial sin yodar" },
    { value: "46692", label: "Venta al por mayor de productos intermedios textiles" },
    { value: "46693", label: "Venta al por mayor de productos intermedios metálicos" },
    { value: "46694", label: "Venta al por mayor de productos intermedios de papel" },
    { value: "46695", label: "Venta al por mayor fertilizantes y agroquímicos" },
    { value: "46696", label: "Venta al por mayor de productos intermedios plásticos" },

    // COMERCIO AL POR MAYOR (Continuación)
    { value: "46697", label: "Venta al por mayor de tintas para imprenta y productos colorantes" },
    { value: "46698", label: "Venta de productos intermedios químicos y de caucho" },
    { value: "46699", label: "Venta al por mayor de productos intermedios y desechos ncp" },
    ...
    { value: "46902", label: "Venta al por mayor de artículos diversos para consumo humano" },
    { value: "46903", label: "Venta al por mayor de armas de fuego y municiones" },
    { value: "46904", label: "Venta al por mayor de toldos y tiendas de campaña" },
    { value: "46905", label: "Venta al por mayor de exhibidores publicitarios y rótulos" },
    { value: "46906", label: "Venta al por mayor de artículos promocionales diversos" },

    // COMERCIO AL POR MENOR
    { value: "47111", label: "Venta en supermercados" },
    { value: "47112", label: "Venta en tiendas de artículos de primera necesidad" },
    { value: "47119", label: "Almacenes (venta de diversos artículos)" },
    { value: "47190", label: "Venta al por menor en comercios no especializados" },
    { value: "47199", label: "Venta en establecimientos no especializados" },
    { value: "47211", label: "Venta al por menor de frutas y hortalizas" },
    { value: "47212", label: "Venta al por menor de carnes, embutidos y productos de granja" },
    { value: "47213", label: "Venta al por menor de pescado y mariscos" },
    { value: "47214", label: "Venta al por menor de productos lácteos" },
    { value: "47215", label: "Venta al por menor de productos de panadería y repostería" },
    { value: "47216", label: "Venta al por menor de huevos" },
    { value: "47217", label: "Venta al por menor de carnes y productos cárnicos" },
    ...
    { value: "47223", label: "Venta de bebidas no alcohólicas para consumo fuera" },
    { value: "47224", label: "Venta de bebidas alcohólicas para consumo fuera" },
    { value: "47225", label: "Venta de bebidas alcohólicas para consumo dentro" },
    { value: "47230", label: "Venta al por menor de tabaco" },
    { value: "47300", label: "Venta de combustibles, lubricantes y otros (gasolineras)" },
    { value: "47411", label: "Venta al por menor de computadoras y equipo periférico" },
    ...
    { value: "47510", label: "Venta al por menor de productos textiles y confecciones" },
    ...
    { value: "47529", label: "Venta al por menor de materiales de construcción" },
    ...
    { value: "47610", label: "Venta al por menor de libros y artículos de papelería" },
    { value: "47620", label: "Venta al por menor de discos y medios audiovisuales" },
    { value: "47630", label: "Venta al por menor de productos y equipos de deporte" },
    ...
    { value: "47713", label: "Venta al por menor de artículos de marroquinería" },
    { value: "47721", label: "Venta al por menor de medicamentos y artículos médicos" },
    { value: "47722", label: "Venta al por menor de productos cosméticos" },
    { value: "47731", label: "Venta al por menor de joyería, óptica y relojería" },
    { value: "47732", label: "Venta al por menor de plantas y artículos conexos" },
    ...
    { value: "47736", label: "Venta al por menor de armas de fuego y accesorios" },
    ...
    { value: "47811", label: "Venta al por menor de frutas y verduras en puestos" },
    { value: "47814", label: "Venta al por menor de productos lácteos en puestos" },
    ...
    { value: "47822", label: "Venta al por menor de artículos textiles en puestos" },
    { value: "47823", label: "Venta al por menor de confecciones en puestos" },
    { value: "47824", label: "Venta al por menor de prendas de vestir en puestos" },
    ...
    { value: "47829", label: "Venta al por menor de artículos textiles ncp en puestos" },
    { value: "47891", label: "Venta al por menor de animales en puestos" },
    { value: "47892", label: "Venta al por menor de productos cosméticos en puestos" },
    { value: "47893", label: "Venta al por menor de artículos de bazar en puestos" },
    { value: "47894", label: "Venta al por menor de artículos de papel en puestos" },
    { value: "47895", label: "Venta al por menor de materiales de construcción en puestos" },
    { value: "47896", label: "Venta al por menor de equipos para comunicaciones en puestos" },
    ...
    { value: "49110", label: "Transporte interurbano de pasajeros por ferrocarril" },
    { value: "49120", label: "Transporte de carga por ferrocarril" },
    { value: "49211", label: "Transporte de pasajeros urbanos mediante buses" },
    { value: "49212", label: "Transporte de pasajeros interdepartamental mediante microbuses" },
    { value: "49213", label: "Transporte de pasajeros urbanos mediante microbuses" },
    { value: "49214", label: "Transporte de pasajeros interdepartamental mediante buses" },
    ...
    { value: "50211", label: "Transporte de pasajeros por vías de navegación interiores" },
    { value: "50212", label: "Alquiler de equipo de transporte acuático con conductor" },
    { value: "50220", label: "Transporte de carga por vías de navegación interiores" },
    { value: "51100", label: "Transporte aéreo de pasajeros" },
    { value: "51201", label: "Transporte de carga por vía aérea" },
    { value: "51202", label: "Alquiler de equipo de aerotransporte con operadores" },
    ...
    { value: "52212", label: "Servicios de terminales para transporte terrestre" },
    ...
    { value: "58130", label: "Edición de periódicos y publicaciones periódicas" },
    ...
    { value: "61209", label: "Servicios de telecomunicaciones inalámbrico n.c.p." },
    ...
    { value: "63110", label: "Procesamiento de datos y actividades relacionadas" },
    ...
    { value: "66190", label: "Actividades auxiliares de intermediación financiera" },
    { value: "66210", label: "Evaluación de riesgos y daños" },
    { value: "66220", label: "Actividades de agentes y corredores de seguros" },
    { value: "66290", label: "Actividades auxiliares de seguros y fondos de pensiones" },
    ...
    { value: "68109", label: "Actividades inmobiliarias con bienes propios n.c.p." },
    { value: "68200", label: "Actividades Inmobiliarias por Retribución o Contrata" },
    ...
    { value: "70200", label: "Actividades de consultoría en gestión empresarial" },
    { value: "71101", label: "Servicios de arquitectura y planificación urbana" },
    ...
    { value: "72100", label: "Investigaciones en ciencias naturales e ingeniería" },
    { value: "72199", label: "Investigaciones científicas" },
    { value: "72200", label: "Investigaciones en ciencias sociales y humanidades" },
    { value: "73100", label: "Publicidad" },

    // ESTUDIOS DE MERCADO
    { value: "73200", label: "Investigación de mercados y encuestas de opinión pública" },
    ...
    { value: "77210", label: "Alquiler y arrendamiento de equipo de recreo y deportivo" },
    { value: "77220", label: "Alquiler de cintas de video y discos" },
    { value: "77290", label: "Alquiler de otros efectos personales y domésticos" },
    ...
    { value: "80201", label: "Actividades de servicios de sistemas de seguridad" },
    ...
    { value: "81290", label: "Otras actividades de mantenimiento de edificios" },
    ...
    { value: "82200", label: "Actividades de centrales de llamadas (call center)" },
    ...
    { value: "87100", label: "Residencias de ancianos con atención de enfermería" },
    ...
    // ASISTENCIA SOCIAL
    { value: "88100", label: "Asistencia social para ancianos y discapacitados" },
    { value: "88900", label: "Servicios sociales sin alojamiento ncp" },

    // ACTIVIDADES ARTÍSTICAS
    { value: "90000", label: "Actividades creativas artísticas y de esparcimiento" },
    ...
    { value: "98100", label: "Producción de bienes de hogares para uso propio" },
    { value: "98200", label: "Producción de servicios de hogares para uso propio" },

    // ORGANIZACIONES EXTRATERRITORIALES
    { value: "99000", label: "Actividades de organizaciones extraterritoriales" },
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
          <div className="bg-white rounded-lg shadow-lg w-full max-w-md mx-2 p-4 flex flex-col">
            <div className="flex justify-between items-center mb-2">
              ...
              <button onClick={() => setShowActivityModal(false)} className="text-xl font-bold">&times;</button>
            </div>
            <input
              type="text"
            ...
            <div className="overflow-y-auto max-h-64 border rounded">
              ...
              {filteredActivities.map(activity => (
                <button
                  key={activity.value}
                  className={`w-full text-left px-3 py-2 hover:bg-gray-100 ${client.codActividad === activity.value ? "bg-green-100" : ""}`}
                  onClick={() => {
      ...
      <div className="flex-1 rounded-mini bg-white shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] flex flex-col items-start justify-start  px-0 pb-[29px] box-border gap-[14px] max-w-full">
        ...
        <div className="self-stretch flex flex-row items-start justify-start py-0 px-3.5 box-border max-w-full">
          <div className="flex-1 flex flex-col items-start justify-start gap-[4px_0px] max-w-full">
            ...
            >
              {(() => {
                const label = allActivities.find(a => a.value === client.codActividad)?.label || "Seleccionar actividad";
