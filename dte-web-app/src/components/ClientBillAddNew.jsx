...
const ClientBillAddNew = ({
  ...
  const handleChange = (field, value) => {
    ...
    const activityMap = {
      ...
      "10001": "Empleados",
      "10003": "Estudiante",
      "97000": "empleadores de personal doméstico",
    ...
    if (field === "codActividad") {
      const selectedActivity = allActivities.find((act) => act.value === value);
      setClient((prevClient) => ({
        ...prevClient,
        actividad_economica: value,
        descActividad: selectedActivity ? selectedActivity.label : "Otros",
      }));
      return;
    }
  ...
  return (
    <section className="animate-fadeInUp self-stretch flex flex-row items-start justify-start py-0 px-2.5 box-border max-w-full text-left text-xs text-black font-inria-sans">
      {/* Modal for Activity Selection */}
      {showActivityModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40 animate-fadeIn">
          <div className="bg-white rounded-lg shadow-lg w-full max-w-md mx-2 p-4 flex flex-col animate-slideInUp">
            <div className="flex justify-between items-center mb-2">
              <h2 className="text-lg font-bold">Seleccionar actividad económica</h2>
              <button
                onClick={() => setShowActivityModal(false)}
                className="text-xl font-bold hover:text-red-500 transition-colors duration-200"
              >
                &times;
              </button>
            </div>
      ...
      <div className="animate-slideInUp animate-delay-200 flex-1 rounded-mini bg-white shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] flex flex-col items-start justify-start pt-0.5 px-0 pb-[29px] box-border gap-[14px] max-w-full">
        {/* Header */}
        <div className="self-stretch flex flex-col items-start justify-start gap-[9.5px_0px] max-w-full text-left text-xs text-black font-inria-sans">
          <div className="self-stretch rounded-t-mini rounded-b-none bg-gainsboro-200 flex flex-row items-start justify-between pt-[11px] pb-[9px] pr-5 pl-[17px] box-border max-w-full gap-[20px] z-[1]">
            <b className="relative z-[2] animate-fadeIn">CLIENTE</b>
          </div>
        </div>
        ...
        <div className="self-stretch flex flex-row items-start justify-start py-0 px-3.5 box-border max-w-full">
          <div className="flex-1 flex flex-col items-start justify-start gap-[16px] max-w-full">
            {/* NIT */}
            <div className="animate-fadeInLeft animate-delay-100 w-full">
            ...
            {/* NRC */}
            <div className="animate-fadeInLeft animate-delay-200 w-full">
              <div className="relative text-xs font-inria-sans text-left z-[1] mb-1">
            ...
            {/* Teléfono */}
            <div className="animate-fadeInRight animate-delay-200 w-full">
              <div className="relative text-xs font-inria-sans text-left z-[1] mb-1">
            ...
            {/* Nombre Comercial */}
            <div className="animate-fadeInRight animate-delay-300 w-full">
              <div className="relative text-xs font-inria-sans text-left z-[1] mb-1">
            ...
            {/* Actividad Económica */}
            <div className="animate-slideInUp animate-delay-100 w-full">
              <div className="relative text-xs font-inria-sans text-left z-[1] mb-1">
            ...
            {/* Correo Electrónico */}
            <div className="animate-slideInUp animate-delay-200 w-full">
              <div className="relative text-xs font-inria-sans text-left z-[1] mb-1">
            ...
            {/* Dirección */}
            <div className="animate-slideInUp animate-delay-300 w-full">
              <div className="relative text-xs font-inria-sans text-left z-[1] mb-1">
            ...
            {visible && (
              <>
                <div className="animate-fadeInUp animate-delay-100 w-full">
                  <div className="relative text-xs font-inria-sans text-left z-[1] mb-1">
                  ...
                  <div className="w-full px-2 h-[30px] relative rounded-md box-border z-[1] border border-gray-300">
                    <select
                      className="w-full h-full border-none outline-none bg-white rounded-md focus:ring-2 focus:ring-blue-500"
                ...
                <div className="animate-fadeInUp animate-delay-200 w-full">
                  <div className="relative text-xs font-inria-sans text-left z-[1] mb-1">
...
export default ClientBillAddNew;
