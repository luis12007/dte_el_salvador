const DataProductNoAdvanceComponentCreate = ({onRemove, handleSelectChangeItemsClient, content}) => {

    const typeLabel = (() => {
        const rawType = content?.type;
        const typeAsString = rawType != null ? String(rawType).trim() : "";
                    ...
                    <div className="flex-1 flex flex-col items-start pl-2 justify-start gap-[5px_0px] max-w-full">
                        ...
                        <div className="self-stretch flex flex-col items-start justify-start gap-[4px_0px] pb-2 max-w-full">
                            ...
                            <div className="self-stretch px-2 h-[23px] relative rounded-6xs box-border z-[1] border-[0.3px] border-solid border-gray-100" >
                                ...
                                ><option value={`${content.type}`}>{typeLabel}</option>
                                </select>
    ...
    export default DataProductNoAdvanceComponentCreate;